            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
              ...
              <div class="container-fluid">
                <a class="navbar-brand" href="#">
                  <img src="./img/pagemuse.png" alt="" width="100" height="100">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li id="btn_documentView" class="nav-item">
                      <a href="/home.html" class="nav-link py-3 px-4" aria-current="page" title="Documents"
                        data-bs-toggle="tooltip" data-bs-placement="right" id="nav-home">
                        Dokuments
                      </a>
                    </li>
                    <li id="btn_deskView" class="nav-item">
                      <a href="/pdfViewer.html" class="nav-link py-3 px-4" title="PDF-Viewer" data-bs-toggle="tooltip"
                        data-bs-placement="right" id="nav-pdfViewer">
                        PDF-Viewer
                      </a>
                    </li>
                    <li id="btn_teams" class="nav-item">
                     <a href="/teams.html" class="nav-link py-3 px-4" title="Teams" data-bs-toggle="tooltip"
                ...
                <div class="dropdown">
                    ...
                    <a href="#" class="align-items-center p-3 link-dark text-decoration-none dropdown-toggle"
                        ...
                        <img src="./img/person-fill.svg" alt="mdo" width="24" height="24" class="rounded-circle" style="background-color: rgb(236, 176, 65);">
                    </a>
